...
export function shouldUseJsonFormat(apiUrl: string, model: string) {
...
export function parseJsonFromAiContent<T>(content: string) {
...
export function shouldDisableThinking(aiConfig: Partial<AiRuntimeConfig>) {
...
export async function requestAiJson<T>(options: RequestAiJsonOptions): Promise<T | null> {
